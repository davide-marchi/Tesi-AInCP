...
def train_kmeans_model(folder, patients, WINDOW_SIZE, N_CLUSTERS, INIT_ALGORITHM, MAX_ITER, METRIC, AVERAGING_METHOD):
    ...
    if not os.path.exists(model_folder + modelname + "/" + modelname):
        ...
        jl.dump(k_means, model_folder + modelname + "/" + modelname)
        ...
        k_means = jl.load(model_folder + modelname + "/" + modelname)
